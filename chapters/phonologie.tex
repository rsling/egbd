...
In (\ref{ex:phol6726b}) ist die Silbenstruktur anders, die Bedingung für die Endranddesonorisierung ist nicht erfüllt, und die Form bleibt unverändert.
...
Weiterhin kann man feststellen, dass im Endrand wegen der Endranddesonorisierung (Abschnitte~\ref{sec:auslautverhaertungphonetik} und~\ref{sec:auslautverhaertungphonologie}) keine stimmhaften Obstruenten vorkommen können, und dass damit \textipa{[b d g v z J]} aus der Betrachtung ausgeschlossen werden können.
...
\begin{exe}
  ...
  \begin{xlist}
    \ex\label{ex:silbenbau1} \textit{Kuh}\\[0.5\baselineskip]\leavevmode
      \SonDiag[2]{{k/\plo/0, u:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{nie}\\[0.5\baselineskip]\leavevmode
      \SonDiag[2]{{n/\nas/0, i:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{Knie}\\[0.5\baselineskip]\leavevmode
      \SonDiag[3]{{k/\plo/0, n/\nas/0, i:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{droh}\\[0.5\baselineskip]\leavevmode
      \SonDiag[3]{{d/\plo/0, K/\liq/0, o:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{steh}\\[0.5\baselineskip]\leavevmode
      \SonDiag[3]{{S/\fri/2, t/\plo/0, e:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{Schnee}\\[0.5\baselineskip]\leavevmode
      \SonDiag[3]{{S/\fri/0, n/\nas/0, e:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{sprüh}\\[0.5\baselineskip]\leavevmode
      \SonDiag[4]{{S/\fri/2, p/\plo/0, K/\liq/0, y:/\vok/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{ab}\\[0.5\baselineskip]\leavevmode
      \SonDiag[3]{{P/\plo/0, a/\vok/0, p/\plo/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{an}\\[0.5\baselineskip]\leavevmode
      \SonDiag[3]{{P/\plo/0, a/\vok/0, n/\nas/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{acht}\\[0.5\baselineskip]\leavevmode
      \SonDiag[4]{{P/\plo/0, a/\vok/0, X/\fri/0, t/\plo/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{Alm}\\[0.5\baselineskip]\leavevmode
      \SonDiag[4]{{P/\plo/0, a/\vok/0, l/\liq/0, m/\nas/0}}\\[0.5\baselineskip]
    \ex\label{ex:silbenbau1} \textit{Raps}\\[0.5\baselineskip]\leavevmode
...
\index{Silbe!Gelenk!Endranddesonorisierung}\label{abs:silbengelenkstimmlos}
