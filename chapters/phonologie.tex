...
\begin{exe}
  ...
  \begin{xlist}
    ...
    \ex{\label{ex:diesystematikderraender112} /ʃnăps/ $\Rightarrow$ [ʃ+naps] (\textit{Schnaps})}
...
\begin{exe}
  ...
  \begin{xlist}
    ...
    \ex{\label{ex:diesystematikderraender123} /lɛ̆ngs/ $\Rightarrow$ [lɛŋs] (\textit{längs})}
    \ex{\label{ex:diesystematikderraender124} /hɛ̆ngt/ $\Rightarrow$ [hɛŋt] (\textit{hängt})}
