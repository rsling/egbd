...
Die Beherrschung der Regeln der orthographischen Silbentrennung im Deutschen erfordert aber subtilere Kenntnisse grammatischer Regularitäten, als sie die Klatschmethode vermitteln kann.
...
\begin{exe}
  ...
  \begin{xlist}
    ...
    \ex\label{ex:sonoritaet099} \textit{Raps}\\[0.5\baselineskip]\leavevmode
      \SonDiag[4]{{K/\liq/0, a/\vok/0, p/\plo/0, s/\fri/2}}\\[0.5\baselineskip]
  \end{xlist}
\end{exe}
