...
\begin{figure}[!htbp]
  \centering
  \SonDiag{{h/\fri, \t{E@}/\vok, p/\plo, s/\fri, t/\plo, s/\fri}}
...
\begin{figure}[!htbp]
  ...
  \Tree[3]{
     ...
     & \K{k}\R{r}^{\text{Plosiv}} & \K{v}\R{ddddrr}^{\text{Frikativ}} &&  \\
     & \K{k\ g}\Rxx{5}{3.7}{r}^{\text{Plosiv}} & \K{n}\R{dddrr}_{\text{Nasal}} &&  \\
     \K{\textipa{S}}\R[--]{r} & \K{p\ t}\R{ddr}^{\text{Plosiv}} &&&  \\
     & \K{b\ d\ k\ g~~~~~~~}\Rxx{4}{11.65}{r} &&&  \\
     & & \K{\textipa{K}}\Rxxx{3.7}{-2.75}{-14}{dddr} && \K{~~~Vokal} \\
     & \K{f}\Rxx{4}{11.65}{r} &&&  \\
     \K{\textipa{S}}\R[--]{r} & \K{v}\R{uur}_{\text{Frikativ}} &&&  \\
     \K{\textipa{S}}\R[--]{r} & \K{p}\R{dr}^{\text{Plosiv}} &&&  \\
     & \K{b\ k\ g}\Rxxx{7}{10.25}{8.25}{ur} & \K{l}\R{uuuurr}_{\text{Liquid}} &&  \\
