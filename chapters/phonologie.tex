...
%     \draw [dashed, |-|, gray, very thick] (0,0.5) -- (0,11.5);
%     \draw [dashed, |-|, gray, very thick] (3,0.5) -- (3,11.5);
%     \draw [dashed, |-|, gray, very thick] (8,0.5) -- (8,11.5);
...
%     \draw [dashed, |-|, gray, very thick] (0,0.5) -- (0,18.5);
%     \draw [dashed, |-, gray, very thick] (3,0.5) -- (3,18);
%     \draw [dashed, |-, gray, very thick] (7,0.5) -- (7,18);
%     \draw [dashed, -, gray, very thick] (3,18) -- (5,18);
%     \draw [dashed, -|, gray, very thick] (7,18) -- (5,18) -- (5,18.5);
%     \draw [dashed, |-|, gray, very thick] (10,0.5) -- (10,18.5);
   
    \node [fill=gray, rounded corners] (vok) at (10, 8.5) {\textcolor{white}{Vokal}};

    \node [segm] (k) at (3,17) {k};
    \node [segm] (v) at (7,17) {v};
    \draw (k.east) -- node [pos=0.7, above] {\footnotesize Plosiv} (v.west);
