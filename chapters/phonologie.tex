...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}[text height=1.5ex, text depth=.25ex, text centered]
    ...
    \node [fill=gray, rounded corners] (vok) at (8, 5.5) {\textcolor{white}{Vokal}};
    
    \node [segm] (plu) at (3,11) {p t};
    \node [extrasyl] (Splu) at (0,11) {S};
    \draw [dashed] (Splu) to (plu);
    \node [segm] (plv) at (3,9) {b d k g (P)};
    \draw (vok.west) -- node [pos=0.7, above, sloped] {\footnotesize Plosiv} (5, 10) -- (plu.east);
    \draw (vok.west) -- (5, 10) -- (plv.east);
    
    \node [segm] (vov) at (3,7) {v};
    \node [extrasyl] (Svov) at (0,7) {S};
    \draw [dashed] (Svov) to (vov);
    \node [segm] (fri) at (3,5) {f S h z J};
    \draw (vok.west) -- node [pos=0.7, above, sloped] {\footnotesize Frikativ} (5, 6) -- (vov.east);
    \draw (vok.west) -- (5, 6) -- (fri.east);

    \node [segm] (nas) at (3,3) {m n};
    \node [extrasyl] (Snas) at (0,3) {S};
    \draw [dashed] (Snas) to (nas);
    \node [segm] (liq) at (3,1) {l K};
    \node [extrasyl] (Sliq) at (0,1) {S};
    \draw [dashed] (Sliq) to (liq);
    \draw (vok.west) to node [pos=0.7, above, sloped] {\footnotesize Nasal} (nas.east);
    \draw (vok.west) to node [pos=0.7, above, sloped] {\footnotesize Liquid} (liq.east);
  \end{tikzpicture}
...
\begin{figure}[!htbp]
  ...
  \begin{tikzpicture}[text height=1.5ex, text depth=.25ex, text centered]
    ...
    \node [fill=gray, rounded corners] (vok) at (10, 8.5) {\textcolor{white}{Vokal}};

    \node [segm] (k) at (3,17) {k};
    \node [segm] (v) at (7,17) {v};
    \draw (k.east) -- node [pos=0.5, above] {\footnotesize Plosiv} (v.west);
    \draw (vok.west) -- node [pos=0.7, above, sloped] {\footnotesize Frikativ} (v.east);

    \node [segm] (kg) at (3,15) {k g};
    \node [segm] (n) at (7,15) {n};
    \draw (kg.east) -- node [pos=0.5, above] {\footnotesize Plosiv} (n.west);
    \draw (vok.west) -- node [pos=0.7, below, sloped] {\footnotesize Nasal} (n.east);

    \node [segm] (pt) at (3,13) {p t};
    \node [extrasyl] (Spt) at (0,13) {S};
    \draw [dashed] (Spt) to (pt);
    \node [segm] (bdkg) at (3,11) {b d k g};
    \node [segm] (f) at (3,9) {f};
    \node [segm] (v1) at (3,7) {v};
    \node [extrasyl] (Sv1) at (0,7) {S};
    \draw [dashed] (Sv1) to (v1);

    \node [segm] (R) at (7,10) {K};
    \draw (pt.east) -- (5,12);
    \draw (bdkg.east) -- (5,12);
    \draw (5,12) -- node [pos=0.3, above, sloped] {\footnotesize Plosiv} (R.west);
    \draw (f.east) -- (5,8);
    \draw (v1.east) -- (5,8);
    \draw (5,8) -- node [pos=0.3, above, sloped] {\footnotesize Frikativ} (R.west);

    \node [segm] (p) at (3,5) {p};
    \node [extrasyl] (Sp) at (0,5) {S};
    \draw [dashed] (Sp) to (p);
    \node [segm] (bkg) at (3,3) {b k g};
    \node [segm] (ff) at (3,1) {f};

    \node [segm] (l) at (7,3) {l};
    \draw (p.east) -- (5,4);
    \draw (bkg.east) -- (5,4);
    \draw (5,4) -- node [pos=0.2, above, sloped] {\footnotesize Plosiv} (l.west);
    \draw (ff.east) -- node [pos=0.5, above, sloped] {\footnotesize Frikativ} (l.west);
    
    \draw (R.east) -- (8,7);
    \draw (l.east) -- (8,7);
    \draw (8,7) -- node [pos=0.5, below, sloped] {\footnotesize Liquid} (vok.west);
...
\begin{figure}[!htbp]
  \begin{tikzpicture}[text height=1.5ex, text depth=.25ex, text centered]
    ...
    \node [fill=gray, rounded corners] (vok) at (0, 6.5) {\textcolor{white}{Vokal}};
    
     \node [segm] (kg) at (6,13) {k (g)};
     \node [segm] (fS) at (6,11) {f S};

     \node [segm] (n) at (3,12) {n};
     \draw (n.east) -- node [pos=0.5, above, sloped] {\footnotesize Plosiv} (kg.west);
     \draw (n.east) -- node [pos=0.5, above, sloped] {\footnotesize Frikativ} (fS.west);

     \node [segm] (p) at (6,9) {p};
     \node [segm] (S) at (6,7) {S};

     \node [segm] (m) at (3,8) {m};
     \draw (m.east) -- node [pos=0.5, above, sloped] {\footnotesize Plosiv} (p.west);
     \draw (m.east) -- node [pos=0.5, above, sloped] {\footnotesize Frikativ} (S.west);

     \draw (vok.east) --  node [pos=0.5, above, sloped] {\footnotesize Nasal} (1.5,10);
     \draw (1.5,10) -- (n.west);
     \draw (1.5,10) -- (m.west);

     \node [segm] (pk) at (6,5) {p k};
     \node [segm] (fSc) at (6,3) {f S ç};
     \node [segm] (mn) at (6,1) {m n};

     \node [segm] (Rl) at (3,3) {K l};
     \draw (Rl.east) -- node [pos=0.5, above, sloped] {\footnotesize Plosiv} (pk.west);
     \draw (Rl.east) -- node [pos=0.5, above, sloped] {\footnotesize Frikativ} (fSc.west);
     \draw (Rl.east) -- node [pos=0.5, above, sloped] {\footnotesize Nasal} (mn.west);
     
     \draw (vok.east) -- node [pos=0.5, above, sloped] {\footnotesize Liquid} (Rl.west);
