...
\begin{figure}[!htbp]
  ...
  \begin{forest}
    decide/.style={draw, chamfered rectangle},
    finall/.style={rounded corners, fill=gray,
      delay={content=\textcolor{white}{##1}}},
      intrme/.style={draw, rounded corners}
    [\textit{Wort}, intrme
      [{Hat\\Numerus?}, decide
        [\textit{flektierbar}, intrme
          [{Ist finit\\flektierbar?}, decide
            [\textbf{Verb}, finall]
            [\textit{Nomen}, intrme
              [{Hat festes\\Genus?}, decide
                [\textbf{Substantiv}, finall]
                [{\textit{anderes}\\\textit{Nomen}}, intrme
                  [{Hat Stärke-\\flexion?}, decide
                    [\textbf{Adjektiv}, finall]
                    [{\textit{Artikel\slash}\\\textit{Pronomen}}, intrme]
                  ]
                ]
              ]
            ]
        ...
        [\textit{nicht flektierbar}, intrme
        [{Hat Valenz-\slash\\Kasusrektion?}, decide
            [\textbf{Präposition}, finall]
            [\textit{andere}, intrme
              [{Leitet Neben-\\Sätze ein?}, decide
                [\textbf{Komplementierer}, finall]
                [{\textit{Partikel\slash}\\\textit{Adverb}}, intrme
                  [{Kann das Vor-\\feld besetzen?}, decide
                    [{\textit{Adverb\slash}\\\textit{Adkopula}}, intrme
                      [{Wird typisch mit\\Kopula verwendet?}, decide
                        [\textbf{Adkopula}, finall]
                        [\textbf{Adverb}, finall]
                      ]
                    ]
                    [\textit{Partikel}, intrme
                      [{Kann Sätze\\ersetzen?}, decide
                        [\textbf{Satzäquivalent}, finall]
                        [\textit{andere}, intrme
                          [{Kann Konsti-\\tuenten verbinden?}, decide
                            [\textbf{Konjunktion}, finall]
                            [\textit{Rest}, intrme]
                          ]
                        ]
                      ]
