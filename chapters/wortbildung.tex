...
Die wichtigsten Fugenelemente sind in Tabelle~\ref{tab:kompositionsfugen010} mit Beispielen angegeben.
...
Tabelle~\ref{tab:derivationmitwortklassenwechsel052} zeigt parallel dazu Beispielwörter.
...
\begin{table}[!htbp]
  ...
  \label{tab:derivationmitwortklassenwechsel052}
\end{table}
