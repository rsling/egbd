...
Den eingeklammerten Ergänzungssatz aus (\ref{ex:funktionaleunterschiedezwischennebensatztypen031}) können wir herausschneiden und den Komplementierer entfernen.
...
\begin{table}
  ...
  \begin{tabular}{llll}
    \lsptoprule
                                   & \textbf{Relativsatz}  & \textbf{Ergänzungssatz} & \textbf{Adverbialsatz} \\
    \midrule
...
Die Matrix ist für Ergänzungs- und Adverbialsätze der einbettende Satz, für Relativsätze die einbettende NP.
...
Die Bedeutung bzw.\ Funktion der drei Typen von Nebensätzen (Ergänzungssatz, Adverbialsatz, Relativsatz) lässt sich auf  die Frage zurückführen, ob die Sätze und ihre Matrix konzeptuell unabhängig sind.
}
...
In (\ref{ex:ergaenzungssaetze129}) regiert es einen \textit{w}"=Fragesatz und in (\ref{ex:komplementsaetze130}) einen Fragesatz mit dem Frage"=Komplementierer \textit{ob}.
...
Wie die Beispiele in (\ref{ex:adverbialsaetze171}) zeigen, stehen Adverbialsätze genauso wie Ergänzungssätze gerne im Vorfeld oder Nachfeld.
...
Adverbialsätze lassen sich (im Gegensatz zu Ergänzungssätzen) oft unter Beibehaltung der Bedeutung in nicht-satzförmige Adverbiale (\zB PPs) umformen.
