...
\footnote{Das Adjektiv \textit{oblique} wird \textipa{[Pob\textprimstress  li:k]} ausgesprochen.
Das zugehörige Substantiv \textit{Obliqueheit} wird dementsprechend \textipa{[Pob\textprimstress  li:kh\t{aE}t]} realisiert.}
...
Wenn wir jetzt Tabelle~\ref{tab:traditionelleflexionsklassen041} als Tabelle~\ref{tab:traditionelleflexionsklassen041-r} wiederholen und die Plural-Affixe vom restlichen Material abtrennen, wird schnell klar, dass das verbleibende Affix-Material eine äußerst sparsame Markierung von Kasus darstellt.
...
Diese Alternation wurde in Vertiefung~\ref{vert:morphemeallomorphe} (vor allem Abbildung~\ref{fig:lexikonregeln049} auf S.~\pageref{fig:lexikonregeln049}) bereits beschrieben.
...
\noindent Zu der Auffälligkeit der schwachen Substantive passt es, dass im Dativ und Akkusativ das Suffix oft weggelassen werden kann, also ein Muster wie in (\ref{ex:schwachesubstantive067}) zu beobachten ist.
...
Eine weitere häufig zu beobachtende Strategie von Sprechern, die Auffälligkeit der schwachen Flexion zu vermeiden und gleichzeitig den Genitiv Singular nach dem allgemeinen Muster zu markieren, ist es, das \textit{-en} als quasi zum Stamm gehörig zu analysieren und wie in (\ref{ex:schwachesubstantive068}) zu flektieren.
...
Da die gemischte Flexion beim indefiniten Artikel (\textit{ein}, \textit{kein}, \textit{mein}, \textit{dein}, \textit{sein}) auftritt, liegt zunächst ein Blick auf Tabelle~\ref{tab:indefiniteartikelundpossessivartikel095} (S.~\pageref{tab:indefiniteartikelundpossessivartikel095}) mit den Formen des indefiniten Artikels nahe.
...
Der Vergleich der starken Adjektivflexion aus Tabelle~\ref{tab:nominaleflexion113} und der Pronominalflexion aus Tabelle~\ref{tab:pronominaunddefiniteartikel087} (S.~\pageref{tab:pronominaunddefiniteartikel087}) zeigt allerdings, dass es sich dabei im Wesentlichen um denselben Satz von Suffixen handelt.
...
Schon bei den Pronomina (Tabelle~\ref{tab:pronominaunddefiniteartikel087}, S.~\pageref{tab:pronominaunddefiniteartikel087}) und dem definiten Artikel (Tabelle~\ref{tab:pronominaunddefiniteartikel089}, S.~\pageref{tab:pronominaunddefiniteartikel089}) fiel aber auf, dass in einem System, in dem die Unterscheidung von Nominativ und Akkusativ sonst fast gar nicht mehr realisiert wird, im pronominalen und adjektivalen Bereich beim Maskulinum der Nominativ und Akkusativ beharrlich unterscheidbar bleiben.
...
Ganz allgemein kann also die gesamte Nominalflexion des Deutschen auf die Pluralklasse der einzelnen Substantive, Tabelle~\ref{tab:pronominaunddefiniteartikel087} (S.~\pageref{tab:pronominaunddefiniteartikel087}) und einige Regularitäten reduziert werden.
