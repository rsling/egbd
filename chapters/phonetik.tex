...
\begin{figure}[!htpb]
  ...
  \path (a) edge [-{Latex[round]}, thick, bend right=15] (oo);
  \path (a) edge [-{Latex[round]}, thick, bend left=15] (E);
  \path (oo) edge [-{Latex[round]}, thick, bend right=15] (ee);
...
\begin{figure}[!htpb]
  ...
  % Draw connections
  \path (y) edge [-{Latex[round]}, thick, bend right=3] (schwaa);	
  \draw [-{Latex[round]}, thick] (Y) -- (schwa);
  \path (e) edge [-{Latex[round]}, thick,bend right=10] (schwaa);
  \path (ee) edge [-{Latex[round]}, thick,bend left=20] (schwa);
  \path (a) edge [-{Latex[round]}, thick,bend right=40] (schwa);
  \path (oo) edge [-{Latex[round]}, thick,bend right=20] (schwa);
  \path (o) edge [-{Latex[round]}, thick,bend left=15] (schwaa);	
  \path (u) edge [-{Latex[round]}, thick,bend left=10] (schwaa);	
  \draw [-{Latex[round]}, thick, bend right] (uu) -- (schwa);
