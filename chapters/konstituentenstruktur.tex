...
In Vertiefung~\ref{vert:flexibilitaetderkoordination} auf Seite~\pageref{vert:flexibilitaetderkoordination} wird nochmals vertiefend auf Gründe eingegangen, die den Test unzuverlässig machen.
...
Damit zeigt sich, dass alle Tests mit größter Vorsicht und nur als Heuristik verwendet werden dürfen.
Statt ein perfektes Beispiel zu suchen, in dem eine solche Interpretation durch die Bedeutung der Wörter komplett ausgeschlossen wird, lassen wir das Beispiel mit diesen Einschränkungen als besonders lehrreich so stehen.}
