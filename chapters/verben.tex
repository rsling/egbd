...
\begin{exe}
  ...
  \begin{xlist}
    ...
    \ex{\label{ex:formendesimperativs106} Komm du mir nur nach Hause!}
  \end{xlist}
\end{exe}
...
\Uebung[\onestar]{verbalflexion02} \label{exc:verbalflexion02} Finden Sie alle Tempusformen (im Sinn von Tabelle~\ref{tab:tempusformen031}, S.~\pageref{tab:tempusformen031}) in den folgenden Sätzen.
