...
Einerseits gibt es sie von einem trunkierenden (abschneidenden) Typus wie \textit{Lok}, \textit{Vopo} oder \textit{Schweini} (vgl.\ Übung~\ref{exc:wortbildung04} auf S.~\pageref{exc:wortbildung04}).
...
Das \textit{ie} für /\textipa{i:}/ ist als einzige Dehnungsschreibung nahezu obligatorisch, und das \textit{h} stellt eine Konstantschreibung zu den Formen des Verbs dar, in denen \textit{h} die Silbengrenze markiert (Abschnitt~\ref{sec:hzwischenvokalen}).
...
\begin{exe}
  \ex{\label{ex:graphematikunabhaengigesaetze053} Die Freundinnen reiten aus.}
  \ex\label{ex:graphematikunabhaengigesaetze054}
  \begin{xlist}
    \ex[ ]{\label{ex:graphematikunabhaengigesaetze055} Emma weiß, dass [die Freundinnen ausreiten].}
    \ex[ ]{\label{ex:graphematikunabhaengigesaetze056} Emma reitet aus, weil [das Wetter schön ist].}
    \ex[ ]{\label{ex:graphematikunabhaengigesaetze057} Emma behauptet, [die Freundinnen reiten aus].}
  \end{xlist}
\end{exe}
...
\begin{exe}
  ...
  \begin{xlist}
    \ex[*]{\label{ex:graphematikunabhaengigesaetze059} Die Freundinnen ausreiten.}
    \ex[*]{\label{ex:graphematikunabhaengigesaetze060} Das Wetter schön ist.}
    \ex[*]{\label{ex:graphematikunabhaengigesaetze061} Reiten aus.}
  \end{xlist}
\end{exe}
...
\begin{exe}
  ...
  \begin{xlist}
    \ex{\label{ex:graphematikunabhaengigesaetze063} Emma ist alleine(!) ins Outback geritten.}
    \ex{\label{ex:graphematikunabhaengigesaetze064} Ich habe gehört, Vanessa(?) hätte Tarek geputzt.}
  \end{xlist}
\end{exe}

Die Verwendungen in (\ref{ex:graphematikunabhaengigesaetze062}) können aber im Gegensatz zur Verwendung als Satzschlusszeichen durchaus als randständig bezeichnet werden.
...
\begin{exe}
  ...
  \begin{xlist}
    \ex{\label{ex:graphematikunabhaengigesaetze066} Emma reitet aus, Vanessa putzt Dragonfly.}
    \ex{\label{ex:graphematikunabhaengigesaetze067} Emma reitet aus. Vanessa putzt Dragonfly.}
  \end{xlist}
\end{exe}
...
\begin{exe}
  ...
  \begin{xlist}
    \ex[?]{\label{ex:graphematikunabhaengigesaetze069} Gestern wurden die Pferde neu behuft, die Lichtgeschwindigkeit ist in allen Bezugssystemen konstant.}
    \ex[ ]{\label{ex:graphematikunabhaengigesaetze070} Gestern wurden die Pferde neu behuft und die Lichtgeschwindigkeit ist in allen Bezugssystemen konstant.}
  \end{xlist}
\end{exe}

Aus ganz verschiedenen inhaltlichen bzw.\ semantischen und syntaktischen Gründen eignen sich die Sätze in (\ref{ex:graphematikunabhaengigesaetze068}) nicht zur Koordination, wobei die Koordination mit \textit{und} wenigstens näherungsweise grammatisch wirkt, was für die Version mit Komma stark angezweifelt werden kann.
...
\begin{exe}
  \ex[*]{\label{ex:graphematikunabhaengigesaetze071} Wir haben gestern den ganzen Tag behuft. Die Pferde.}
  \ex\label{ex:graphematikunabhaengigesaetze072}
  \begin{xlist}
    \ex[ ]{\label{ex:graphematikunabhaengigesaetze073} Wir haben das Pferd gestern neu behufen lassen, das immer so gerne ins Gelände reitet. Der Hufschmied meinte, es wäre höchste Zeit.}
    \ex[*]{\label{ex:graphematikunabhaengigesaetze074} Wir haben das Pferd gestern neu behufen lassen. Der Hufschmied meinte, es wäre höchste Zeit. Das immer so gerne ins Gelände reitet.}
  \end{xlist}
\end{exe}

Im Gegensatz dazu stellen Beispiele wie die in (\ref{ex:graphematikunabhaengigesaetze075}) ein Problem dar, weil hier Satzendezeichen verwendet werden, aber das abgetrennte Material nach unserer Definition nicht satzförmig ist.

\begin{exe}
  \ex\label{ex:graphematikunabhaengigesaetze075}
  \begin{xlist}
    \ex{\label{ex:graphematikunabhaengigesaetze076} Edgar öffnete die Motorhaube. Totalschaden.}
    \ex{\label{ex:graphematikunabhaengigesaetze077} Ich, ein Lügner?}
    \ex{\label{ex:graphematikunabhaengigesaetze078} Raus!}
  \end{xlist}
\end{exe}
...
\begin{exe}
  ...
  \begin{xlist}
    \ex{\label{ex:graphematikunabhaengigesaetze080} Edgar öffnete die Motorhaube. Es war ein Totalschaden.}
    \ex{\label{ex:graphematikunabhaengigesaetze081} Ich soll ein Lügner sein?}
    \ex{\label{ex:graphematikunabhaengigesaetze082} Mach, dass du rauskommst!}
  \end{xlist}
\end{exe}
