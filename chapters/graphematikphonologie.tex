...
Auch das ist ein Trugschluss, denn hier ist regelhaft ein hypothetisches phonologisches Wort /\textipa{lInguzitIk}/ kodiert worden.
...
In solchen Wörtern sollte ein /\textipa{z}/ nicht möglich sein, denn durch die Silbengelenkposition steht das Segment ja stets in einem Endrand, in dem die Endrand-Desonorisierung wirkt und bewirkt, dass jedes /\textipa{z}/ als \textipa{[s]} realisiert wird (s.\ auch Abschnitt~\ref{sec:einsilblerundzweisilbler}, besonders Seite~\pageref{abs:einsilblerundzweisilbler149}).
...
Ein Wort wie \textit{Christen} (statt *\textit{Kristen}) ist phonologisch in keiner Form auf"|fällig, sticht aber durch die Schreibung \textipa{[chr]} für /\textipa{kK}/ heraus.
...
\Uebung{phonologischeschreibprinzipien01} \label{exc:phonologischeschreibprinzipien01} In Tabelle~\ref{tab:dehnungsundschaerfungsschreibungen010} (Seite~\pageref{tab:dehnungsundschaerfungsschreibungen010}) fehlen die Vokale /\textipa{y}/, /\textipa{Y}/ und /\textipa{\o}/, /\textipa{\oe}/.
