...
Dies erfordert laut Peter Eisenberg, dass Lehrende sich auf die Sprache der Lernenden einlassen und sie im Sinn eines analytischen Verständnisses durchschauen können müssen.
...
Viel mehr noch als bei den Lernenden erfordert das Sprechen über Sprache ein \textit{Wissen} über diese Sprache, nicht nur das \textit{Können} dieser Sprache \citep[94]{Bredel2013}.
Im Linguistikstudium wird also nicht unbedingt die Grammatik an zukünftige Lehrende vermittelt, die sie dann so direkt an Kinder und Jugendliche weitergeben sollen, sondern genau die Grammatik, die Lehrende benötigen, um in der Vermittlung der schulgerechten Grammatik erfolgreich und souverän handeln zu können (so auch \citealt[19]{Eisenberg2004}).
...
Sie müssen sprachliche Leistungen bewerten.
...
\footnote{Auch die Fachdidaktik ist keine praktische Anleitung zur Unterrichtsvorbereitung, sondern die wissenschaftliche Ausbildung für das richtige Handeln im Unterricht \citet[15]{Bredel2013}.
...
Deswegen sind zum Beispiel die gegebenen Definitionen sprachlich penibel und rigoros.
...
Ganz unabhängig davon sehen wir an (\ref{ex:formundfunktionindergrammatik004}), dass die systeminternen Interaktionen weiter reichen, als manche vielleicht zunächst annehmen.
...
Abgesehen davon, dass angehende Lehrpersonen im dritten und vierten Studienjahr keinerlei Probleme mit Aufgaben aus dem schulischen Grammatikunterricht mehr haben dürften, zeigen solche Ergebnisse, dass gerade nicht die Fähigkeit ausgebildet wurde, konstruktiv uns systematisch mit komplexeren sprachlichen Formen umzugehen.
Unterstrichen wird dies noch dadurch, dass 20,9\% der Teilnehmenden diese Aufgabe überhaupt nicht zu lösen versucht haben.
Man kapituliert.
...
\footnote{Gender war ein Textfeld ohne vorgegebene Optionen.}
...
Auf Basis er Stichprobe lässt sich nun nicht beliebig verallgemeinern, weil vierzig Teilnehmende die zweite Auflage von \textit{Einführung in die grammatische Beschreibung des Deutschen} verwendet haben, aber nur vier nicht.
...
\footnote{Rein formale Punkte wie \textit{Kenntnis grammatischer Kategorien vermitteln} wurden dabei durchgehend von weniger als 10\% genannt.
...
Auch die Motivation für das Thema ist (zumindest innerhalb der nicht ganz repräsentativen Stichprobe) hoch.
63,6\% finden Grammatik interessant oder sehr interessant, nur 14,9\% geben hier uninteressant oder sehr uninteressant an.
